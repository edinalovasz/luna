import {
  ADD_REVIEW_TO_LIST,
  LIKE_RESTAURANT_PROFILE_REVIEW,
  RESET_RESTAURANT,
  REMOVE_REVIEW_IN_LIST,
  SET_RESTAURANT_OBJ,
...
export const restaurantReducer = (state = initialState, action) => {
  ...
  switch (action.type) {
    ...
    case SET_RESTAURANT_REVIEWS: {
      console.log("reviews in reducer", action.payload);
    ...
    case ADD_REVIEW_TO_LIST: {
      ...
      return {
        ...newState,
        restaurantReviews: [action.payload, ...newState.restaurantReviews],
      };
    }
    case UPDATE_REVIEW_IN_LIST: {
      let index = newState.restaurantReviews.findIndex(
